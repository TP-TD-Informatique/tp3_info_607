...
int nb_tests = 10; // nombre de tests à faire pour vérifier que la clé trouvée
                   // est correcte
int nb_retries
    = 0; // lorsque la clé trouvée est incorrecte, nombre de passage à refaire
...
void display_help(char* exe)
{
    ...
    printf(
        ...
        "  --nb_retries=<N>, -C<N>\n"
        "      spécifie le nombre maximal de prédictions de clé à faire "
...
int main(int argc, char* argv[])
{
    ...
    static const struct option long_options[]
        = { { "key_size", required_argument, NULL, 'l' },
              ...
              { "nb_retries", required_argument, NULL, 'R' },
